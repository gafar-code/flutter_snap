...
import 'package:flutter_snap_example/lens_model.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  String runPowerShellScript(String hotKey) {
    ...
    return Process.runSync(
            'Powershell.exe', ['-File', "$currentDir" r"\snap_camera.ps1", hotKey])
        .stdout as String;
  }
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: lenses
                    .map((len) => InkWell(
                          onTap: () {
                            // do hotkey action in dart
                            log(runPowerShellScript(len.hotKey));
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              border: len.id == _selectedLens?.id
                                  ? Border.all(color: Colors.red)
                                  : null,
                              image: DecorationImage(
                                image: AssetImage(len.thumb),
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
